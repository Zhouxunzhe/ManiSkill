...
class Agent(nn.Module):
    def __init__(self, env: VectorEnv, args: Args, device):
        ...
        self.target_net = MLPTargetNet(self.policy.mlp).to(device)
        self.hypernet = Hypernet(self.target_net, ftask_dim, weight_dim, deriv_hidden_dim, driv_num_layers,
    ...
    def get_action(self, obs_seq, val_videos):
        ...
        with torch.no_grad():
            ...
            actions = self.policy(obs_cond, mlp_params=generated_weight)
