...
def publish_trajectory(positions, duration=1.0):
    ...
    traj.joint_names = ['left_index_1_joint', 'left_little_1_joint', 'left_middle_1_joint', 
                        'left_ring_1_joint', 'left_thumb_2_joint', 'left_thumb_1_joint']
...
if __name__ == '__main__':
    try:
        ...
        # 动作 1
        publish_trajectory([0, 0, 0, 0, 0, 0], duration=1.5)
        rospy.sleep(1)
        
        # 动作 2
        publish_trajectory([1.2, 0.5, 0.5, 0.5, 0.4, 0], duration=1.5)
        rospy.sleep(1)
        
        # 动作 3
        publish_trajectory([1.6, 1.6, 1.6, 1.6, 0.4, 0], duration=1.5)
