...
@register_env(
    "OpenCabinetDrawerRealman-v1",
    asset_download_ids=["partnet_mobility_cabinet"],
    max_episode_steps=100,
)
class OpenCabinetDrawerRealmanEnv(BaseEnv):
    """
    **Task Description:**
    ...
    **Goal Specification:**
    ...
    def _load_scene(self, options: dict):
        ...
        from mani_skill.agents.robots.realman import REALMAN_WHEELS_COLLISION_BIT

        self.ground.set_collision_group_bit(
            group=2, bit_idx=REALMAN_WHEELS_COLLISION_BIT, bit=1
        )
        self.ground.set_collision_group_bit(
...
@register_env("OpenCabinetDoorRealman-v1", max_episode_steps=100)
class OpenCabinetDoorRealmanEnv(OpenCabinetDrawerRealmanEnv):
    TRAIN_JSON = (
