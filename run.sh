...
python -m examples.baselines.diffusion_policy.train_rgbd --env-id FoldSuitcase-v1 \
  --demo-path /home/zhouxunzhe/robo_dev/ManiSkill/demos/FoldSuitcase-v1/motionplanning/wo_tactile/suitcase_1k.rgb.pd_joint_delta_pos.cpu.h5 \
  --control-mode "pd_joint_delta_pos" --sim-backend "cpu" --num-demos 800 --max_episode_steps 500 --total_iters 300000 \
  --log_freq 1000 --save_freq 1000 --num_eval_episodes 100 --num_eval_envs 1 --visual_encoder clip --exp_name Fold-v1-CLIP-1K-800
